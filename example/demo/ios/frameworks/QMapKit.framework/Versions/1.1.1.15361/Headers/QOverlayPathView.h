...
/*!
 *  @brief  该类提供使用CGPathRef来绘制overlay,默认的操作是使用fill属性和stroke属性绘制当前path到context中, 希望不要直接实例化, 可以使用该类的子类QCircleView, QPolylineView, QPolygonView或者继承该类, 如果继承该类，需要重载-(void)createPath方法
 */
